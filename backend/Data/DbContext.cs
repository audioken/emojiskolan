    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Emoji>().HasData(
                ...
                new Emoji { Id = 95, Symbol = "🏤", Description = "Poststation", LevelId = 7 },
                ...
                // Level 8 (Symbols & Shapes)
                new Emoji { Id = 106, Symbol = "❤️", Description = "Hjärta", LevelId = 8 },
                new Emoji { Id = 107, Symbol = "💔", Description = "Brusten", LevelId = 8 },
                new Emoji { Id = 108, Symbol = "⭐", Description = "Stjärna", LevelId = 8 },
                new Emoji { Id = 109, Symbol = "✨", Description = "Glans", LevelId = 8 },
                new Emoji { Id = 110, Symbol = "⚡", Description = "Blixt", LevelId = 8 },
                new Emoji { Id = 111, Symbol = "🔥", Description = "Eld", LevelId = 8 },
                new Emoji { Id = 112, Symbol = "💧", Description = "Droppe", LevelId = 8 },
                new Emoji { Id = 113, Symbol = "❗", Description = "Utrop", LevelId = 8 },
                new Emoji { Id = 114, Symbol = "❓", Description = "Fråga", LevelId = 8 },
                new Emoji { Id = 115, Symbol = "✅", Description = "Klar", LevelId = 8 },
                new Emoji { Id = 116, Symbol = "❌", Description = "Fel", LevelId = 8 },
                new Emoji { Id = 117, Symbol = "➕", Description = "Plus", LevelId = 8 },
                new Emoji { Id = 118, Symbol = "➖", Description = "Minus", LevelId = 8 },
                new Emoji { Id = 119, Symbol = "➗", Description = "Division", LevelId = 8 },
                new Emoji { Id = 120, Symbol = "🔺", Description = "Triangel", LevelId = 8 },

                // Level 9 (Emotions)
                new Emoji { Id = 121, Symbol = "🙂", Description = "Glad", LevelId = 9 },
                new Emoji { Id = 122, Symbol = "😢", Description = "Ledsen", LevelId = 9 },
                new Emoji { Id = 123, Symbol = "😠", Description = "Arg", LevelId = 9 },
                new Emoji { Id = 124, Symbol = "😍", Description = "Kär", LevelId = 9 }, 
                new Emoji { Id = 125, Symbol = "😮", Description = "Förvånad", LevelId = 9 },
                new Emoji { Id = 126, Symbol = "😬", Description = "Spänd", LevelId = 9 },
                new Emoji { Id = 127, Symbol = "😲", Description = "Chockad", LevelId = 9 },
                new Emoji { Id = 128, Symbol = "😤", Description = "Frustrerad", LevelId = 9 },
                new Emoji { Id = 129, Symbol = "😡", Description = "Ilska", LevelId = 9 },
                new Emoji { Id = 130, Symbol = "😊", Description = "Nöjd", LevelId = 9 }, 
                new Emoji { Id = 131, Symbol = "😃", Description = "Entusiastisk", LevelId = 9 },
                new Emoji { Id = 132, Symbol = "😕", Description = "Förvirrad", LevelId = 9 },
                new Emoji { Id = 133, Symbol = "😅", Description = "Nervös", LevelId = 9 },
                new Emoji { Id = 134, Symbol = "😌", Description = "Lugn", LevelId = 9 },
                new Emoji { Id = 135, Symbol = "😱", Description = "Rädd", LevelId = 9 },

                // Level 10 (Expressions)
                new Emoji { Id = 136, Symbol = "😉", Description = "Blinkar", LevelId = 10 },
                new Emoji { Id = 137, Symbol = "😏", Description = "Flinar", LevelId = 10 },
                new Emoji { Id = 138, Symbol = "🙃", Description = "Oseriös", LevelId = 10 },
                new Emoji { Id = 139, Symbol = "🤔", Description = "Tänker", LevelId = 10 },
                new Emoji { Id = 140, Symbol = "😋", Description = "Njuter", LevelId = 10 },
                new Emoji { Id = 141, Symbol = "😜", Description = "Busig", LevelId = 10 },
                new Emoji { Id = 142, Symbol = "🤭", Description = "Fnissar", LevelId = 10 },
                new Emoji { Id = 143, Symbol = "😛", Description = "Skämtar", LevelId = 10 },
                new Emoji { Id = 144, Symbol = "😎", Description = "Cool", LevelId = 10 },
                new Emoji { Id = 145, Symbol = "😂", Description = "Skrattar", LevelId = 10 },
                new Emoji { Id = 146, Symbol = "🤩", Description = "Imponerad", LevelId = 10 },
                new Emoji { Id = 147, Symbol = "🥹", Description = "Rörd", LevelId = 10 },
                new Emoji { Id = 148, Symbol = "🤤", Description = "Dreglar", LevelId = 10 },
                new Emoji { Id = 149, Symbol = "🫠", Description = "Smälter", LevelId = 10 },
                new Emoji { Id = 150, Symbol = "🤮", Description = "Kräks", LevelId = 10 }
            );
